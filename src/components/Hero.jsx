...
const Hero = () => {
  const right =
    "https://udevs.io/static/hero-304cdf863047286a47c1e063154824d8.svg";
  const logo =
  ...
  return (
    <div className="w-full items-center justify-center py-24  pt-40 ">
      <div className="flex max-w-[1280px] w-full px-5 items-center mx-auto justify-between">
        <div className="w-1/2">
          <img src={logo} alt="Logo" className="w-[250px]" />
          <h2 className="text-[#454359] text-[40px] pt-6 font-semibold">
            IT-Outsourcing Company
          </h2>
          <h1 className="flex items-center justify-start text-start text-blue-700 text-[40px] w-full pt-4 font-semibold">
            <span>{typeEffect}</span>
          </h1>
        </div>
        <div className="w-1/2">
          <img src={right} alt="Hero Image" />
        </div>
      </div>
    </div>
  );
